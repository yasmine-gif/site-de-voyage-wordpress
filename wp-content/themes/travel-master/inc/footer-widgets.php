...
class Travel_Master_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'travel_master';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'travel-master' ), $i ),
...
// Initialize.
$travel_master_footer_widgets = new Travel_Master_Footer_Widgets();
