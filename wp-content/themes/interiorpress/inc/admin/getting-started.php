	...
	<div class="wrap getting-started">
		...
		<div class="intro-wrap">
			<div class="intro">
				...
				<p><?php esc_html_e( 'InteriorPress is a creative and professional multipurpose WordPress theme that is suited for business, consultant, finance, digital agency, industries, online shop and many other various site types.', 'interiorpress' ); ?></p>
			</div>
